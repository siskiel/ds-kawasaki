...
<form method="post">
	...
	<div class="form-group">
		<label>Nilai Densistas</label>
			<input type="float" class="form-control" name="nilai" required>
	</div>
...
if(isset($_POST['save']))
{
    ...
    $koneksi->query("INSERT INTO gejala (kode_gejala,nama_gejala,nilai_ds) VALUES('$_POST[kode]','$_POST[nama]','$_POST[nilai]')");
