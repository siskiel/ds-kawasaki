...
<head>
    ...
    <title>Admin | Expert System</title>
	<!-- BOOTSTRAP STYLES-->
...
font-size: 16px;"><span id="tanggalwaktu">   </span> 
           <a href="index.php?halaman=logout" class="btn btn-success square-btn-adjust">    Logout</a> </div>
        </nav>   
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a href="index.php?halaman=kerusakan"><i class="fa fa-search fa-2x"></i> Kerusakan</a>
                    </li>
                    <li>
                        <a href="index.php?halaman=rule"><i class="fa fa-cloud fa-2x"></i> Rules Base</a>
                    </li> 
                    <li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                if (isset($_GET['halaman']))
                {
                    ...
                    elseif($_GET['halaman']=="kerusakan"){
                        include 'kerusakan.php';
                    }
                    elseif($_GET['halaman']=="kerusakanhapus"){
                        include 'kerusakanhapus.php';
                    }
                    elseif($_GET['halaman']=="kerusakantambah"){
                        include 'kerusakantambah.php';
                    }
                    elseif($_GET['halaman']=="kerusakanubah"){
                        include 'kerusakanubah.php';
                    }
